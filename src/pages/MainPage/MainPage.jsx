...
export default function MainPage() {
  ...
  const banners = [
    { text: "주식으로 떠나는 여행\n투자부터 환전까지 한 번에!", img: "/assets/images/main/airplane.svg" },
    { text: "목표 금액을 설정하면, 자동 매도와 환전이 손쉽게!", img: "/assets/images/main/chart.svg" },
  ];
      ...
      <div className={styles["service-grid"]}>
        <div className={styles["service-card"]}>
          <div className={styles["icon-wrapper"]}>
            <img src="/assets/images/main/wallet.svg" alt="환전지갑" className={styles["service-icon"]} />
          </div>
        ...
        <div className={styles["service-card"]}>
          <div className={styles["icon-wrapper"]}>
            <img src="/assets/images/main/portfolio.svg" alt="포트폴리오" className={styles["service-icon"]} />
          </div>
        ...
        <div className={styles["service-card"]}>
          <div className={styles["icon-wrapper"]}>
            <img src="/assets/images/main/trip.svg" alt="여행지" className={styles["service-icon"]} />
          </div>
