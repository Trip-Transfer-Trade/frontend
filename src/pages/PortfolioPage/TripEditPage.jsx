        ...
        <div className="flex-1 pb-20">
          ...
          <div className="mb-8 text-center">
            <p className="font-medium">
              <span className="text-blue-600 font-bold">{newCountry}</span> 으로
              떠나기 위해
            </p>
            <p className="font-medium">
              <span className="text-blue-600 font-bold">{newDate}</span> 까지{" "}
